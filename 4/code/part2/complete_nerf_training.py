...
def train_nerf_with_visualization():
    ...
    """
    print("=== NeRF Training for Lego Dataset ===")
    ...
    save_epochs = [10, 100, 300, 500, 1000]
    rendered_images = {}
    ...
    # Save model
    torch.save(model.state_dict(), "nerf_lego_model.pth")
    print("Model saved to nerf_lego_model.pth")
    ...
    for epoch, image in rendered_images.items():
    ...
    print("8. Trained model: nerf_lego_model.pth")
